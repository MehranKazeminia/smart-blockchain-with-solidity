...
//  This function is of the "view type" and has no computational significance.
    ...
    function balanceOf(address _account) public view returns(uint _accountBalance, string memory _nameOfCoins, 
        string memory _symbolOfCoins, uint _accountOpeningTime, address _accountAddress) {
...
//  This function is of the "view type" and has no computational significance.
    ...
    function lastBlock() public view returns (string memory _nameOfCoins, string memory _symbolOfCoins, 
        uint _numberOfTransactions, uint _lastTransactionValue, uint _lastTransactionTime, 
        address _senderAddress, address _recipientAddress) {
