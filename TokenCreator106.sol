...
// __________________________________________________________________________________________   
//  My account information | This function is of the "view type".

    function myAccountInformation() public view isMember() returns(string memory _nameOfCoins, string memory _symbolOfCoins, 
        uint256 _yourAccountBalance, uint256 _accountOpeningTime, uint256 _lastTimeAsSender, address _myAddress) {
        ...
        _lastTimeAsSender = accounts[msg.sender].lastTimeAsSender;
        _myAddress = msg.sender;
    }
// __________________________________________________________________________________________ 
//  System information | This function is of the "view type".
    
    function systemInformation() public view returns(string memory _nameOfCoins, string memory _symbolOfCoins, 
        uint256 _totalNumberOfCoines, uint256 _priceOfEachCoin, uint256 _contractBalance, uint128 _numberOfAccounts, 
        uint128 _numberOfTransactions) {
...
// __________________________________________________________________________________________ 
//  Last transaction  | This function is of the "view type".

    function lastBlock() public view returns (string memory _nameOfCoins, string memory _symbolOfCoins, 
        uint256 _lastTransactionValue, uint256 _lastTransactionTime, address _senderAddress, address _recipientAddress) {
            
        _nameOfCoins = name;            
        _symbolOfCoins = symbol;  
        _lastTransactionValue = trxes[trxCount].trxValue;
        _lastTransactionTime = trxes[trxCount].trxTime;             
        _senderAddress = trxes[trxCount].senderAddress;            
        _recipientAddress = trxes[trxCount].recipientAddress;            
    }      
// __________________________________________________________________________________________
//  Buying Coins from the owner   
    ...
    function buyTokens() public payable returns(bool) {
        ...
        emit NewPaymentBasedEther();
        return true;        
    } 
// __________________________________________________________________________________________
//  Payment to the owner by contract   
